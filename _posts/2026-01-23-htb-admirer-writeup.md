...
![Nmap scan results][/assets/imgages/admirer/Captura2.PNG]
...
![Nmap scan results][/assets/imgages/admirer/Captura3.PNG]
![Nmap scan results][/assets/imgages/admirer/Captura4.PNG]
...
![Nmap scan results][/assets/imgages/admirer/Captura5.PNG]
...
![Nmap scan results][/assets/imgages/admirer/Captura6.PNG]
Credentials.txt
![Nmap scan results][/assets/imgages/admirer/Captura7.PNG]
Contacts.txt
![Nmap scan results][/assets/imgages/admirer/Captura8.PNG]
...
![Nmap scan results][/assets/imgages/admirer/Captura9.PNG]

These two files both look interesting, I will transfer them to my machine and take a closer look:

![Nmap scan results][/assets/imgages/admirer/Captura10.PNG]
...
![Nmap scan results][/assets/imgages/admirer/Captura11.PNG]

We also obtained a html.tar.gz, extracted it’s contents to reveal a backup of the site

![Nmap scan results][/assets/imgages/admirer/Captura12.PNG]
![Nmap scan results][/assets/imgages/admirer/Captura13.PNG]
...
![Nmap scan results][/assets/imgages/admirer/Captura14.PNG]
![Nmap scan results][/assets/imgages/admirer/Captura15.PNG]
